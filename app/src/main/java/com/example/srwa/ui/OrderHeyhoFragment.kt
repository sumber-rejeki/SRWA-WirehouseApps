...
class OrderHeyhoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_order_heyho, container, false)
        ...
        order = Order(
            ...
            shippingDestination = "Heyho Store, Central Jakarta"
        )
